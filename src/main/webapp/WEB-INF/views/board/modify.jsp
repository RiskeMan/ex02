...
<body class="d-flex flex-column h-100">
								...
								<div class="box-body">
									...
									<div class="form-group">
										<label for="writer">WRITER</label> <input type="text"
											class="form-control" name="writer" id="writer" readonly
											value="${ board.writer }">
									</div>
									<div class="form-group">
										<label>Content</label>
									...
									<div class="form-group">
										<label for="title">updateddate</label> <input type="text"
											...
											value='<fmt:formatDate value="${ board.updateddate }" pattern="yyyy/MM/dd" />' readonly>
									</div>
								</div>
	...
	<script>
		document.getElementById("btn_cancel").addEventListener("click", btn_cancel);
